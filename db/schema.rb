...
ActiveRecord::Schema[7.1].define(version: 2024_05_07_223325) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "patterns", comment: "Dreambook patterns (common)", force: :cascade do |t|
    ...
    t.index "lower((name)::text)", name: "index_patterns_on_lower_name", unique: true
